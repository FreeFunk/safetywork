...
import com.edgedo.sys.service.CarInfoService;
...
public class CarInfoController extends BaseController{
	...
	public ModelAndView  selectByCarPlateNum(String carPlateNumStr){
		ModelAndView modelAndView = new ModelAndView();
		String [] carArr = carPlateNumStr.split(",");
		List<CarInfo> carInfoList = service.selectByCarPlateNum(carArr);

		return buildResponse(modelAndView, carInfoList);
	}
